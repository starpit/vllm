...
**Branch**: `ff-interpreter` (this worktree). Tip: `a5ad45609`.
...
```
3250 cuBLAS picks → 2689   (-561, -17%)   across 271 model variants
```

Picks aren't the whole story (see "Surface area is wider than picks suggest" below) but they're the live-dashboard metric.
