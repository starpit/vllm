...
use ferrite_kernels::cutlass::{
    cutlass_gemm_16x64_s3_bf16_launch, cutlass_gemm_16x64_s4_bf16_launch,
    cutlass_gemm_16x64_s4_sk2_bf16_launch, cutlass_gemm_16x64_s4_sk4_bf16_launch,
    cutlass_gemm_16x64_s4_sk8_bf16_launch, cutlass_gemm_16x128_s3_bf16_launch,
    cutlass_gemm_16x128_s4_bf16_launch, cutlass_gemm_16x128_s4_sk2_bf16_launch,
    cutlass_gemm_16x128_s4_sk4_bf16_launch, cutlass_gemm_16x128_s4_sk8_bf16_launch,
    cutlass_gemm_32x64_s3_bf16_launch, cutlass_gemm_32x64_s4_bf16_launch,
    cutlass_gemm_32x128_s3_bf16_launch, cutlass_gemm_32x128_s4_bf16_launch,
    cutlass_gemm_32x256_s3_bf16_launch, cutlass_gemm_64x64_s3_bf16_launch,
    cutlass_gemm_64x64_s4_bf16_launch, cutlass_gemm_64x64_s4_sk2_bf16_launch,
    cutlass_gemm_64x64_s4_sk4_bf16_launch, cutlass_gemm_64x64_s4_sk8_bf16_launch,
    cutlass_gemm_64x128_s3_bf16_launch, cutlass_gemm_64x128_s4_bf16_launch,
    cutlass_gemm_64x128_s4_sk2_bf16_launch, cutlass_gemm_64x128_s4_sk4_bf16_launch,
    cutlass_gemm_64x128_s4_sk8_bf16_launch, cutlass_gemm_128x64_s3_bf16_launch,
    cutlass_gemm_128x64_s4_bf16_launch, cutlass_gemm_128x64_s4_sk2_bf16_launch,
    cutlass_gemm_128x64_s4_sk4_bf16_launch, cutlass_gemm_128x64_s4_sk8_bf16_launch,
    cutlass_gemm_128x128_s3_bf16_launch, cutlass_gemm_128x128_s4_bf16_launch,
    cutlass_gemm_128x128_s4_sk2_bf16_launch, cutlass_gemm_128x128_s4_sk4_bf16_launch,
    cutlass_gemm_128x128_s4_sk8_bf16_launch, cutlass_gemm_128x256_s3_bf16_launch,
    cutlass_gemm_256x64_s3_bf16_launch, cutlass_gemm_256x64_s4_bf16_launch,
    cutlass_gemm_bias_16x64_s3_bf16_launch, cutlass_gemm_bias_16x64_s4_bf16_launch,
    cutlass_gemm_bias_16x128_s3_bf16_launch, cutlass_gemm_bias_16x128_s4_bf16_launch,
    cutlass_gemm_bias_32x64_s3_bf16_launch, cutlass_gemm_bias_32x64_s4_bf16_launch,
    cutlass_gemm_bias_32x128_s3_bf16_launch, cutlass_gemm_bias_32x128_s4_bf16_launch,
    cutlass_gemm_bias_32x256_s3_bf16_launch, cutlass_gemm_bias_64x64_s3_bf16_launch,
    cutlass_gemm_bias_64x64_s4_bf16_launch, cutlass_gemm_bias_64x128_s3_bf16_launch,
    cutlass_gemm_bias_64x128_s4_bf16_launch, cutlass_gemm_bias_128x64_s3_bf16_launch,
    cutlass_gemm_bias_128x64_s4_bf16_launch, cutlass_gemm_bias_128x128_s3_bf16_launch,
    cutlass_gemm_bias_128x128_s4_bf16_launch, cutlass_gemm_bias_128x256_s3_bf16_launch,
    cutlass_gemm_bias_256x64_s3_bf16_launch, cutlass_gemm_bias_256x64_s4_bf16_launch,
    cutlass_gemm_silu_mul_bf16_launch, cutlass_gemv_bf16_launch,
};
...
fn bench_one_shape(
    ...
    bench_cutlass!(
        "cutlass_16x64_s3"   => cutlass_gemm_16x64_s3_bf16_launch,
        "cutlass_16x64_s4"   => cutlass_gemm_16x64_s4_bf16_launch,
        "cutlass_16x128_s3"  => cutlass_gemm_16x128_s3_bf16_launch,
        "cutlass_16x128_s4"  => cutlass_gemm_16x128_s4_bf16_launch,
        "cutlass_32x64_s3"   => cutlass_gemm_32x64_s3_bf16_launch,
        "cutlass_32x64_s4"   => cutlass_gemm_32x64_s4_bf16_launch,
        "cutlass_32x128_s3"  => cutlass_gemm_32x128_s3_bf16_launch,
        "cutlass_32x128_s4"  => cutlass_gemm_32x128_s4_bf16_launch,
        "cutlass_32x256_s3"  => cutlass_gemm_32x256_s3_bf16_launch,
        "cutlass_64x64_s3"   => cutlass_gemm_64x64_s3_bf16_launch,
        "cutlass_64x64_s4"   => cutlass_gemm_64x64_s4_bf16_launch,
        "cutlass_64x128_s3"  => cutlass_gemm_64x128_s3_bf16_launch,
        "cutlass_64x128_s4"  => cutlass_gemm_64x128_s4_bf16_launch,
        "cutlass_128x64_s3"  => cutlass_gemm_128x64_s3_bf16_launch,
        "cutlass_128x64_s4"  => cutlass_gemm_128x64_s4_bf16_launch,
        "cutlass_128x128_s3" => cutlass_gemm_128x128_s3_bf16_launch,
        "cutlass_128x128_s4" => cutlass_gemm_128x128_s4_bf16_launch,
        "cutlass_128x256_s3" => cutlass_gemm_128x256_s3_bf16_launch,
        "cutlass_256x64_s3"  => cutlass_gemm_256x64_s3_bf16_launch,
        "cutlass_256x64_s4"  => cutlass_gemm_256x64_s4_bf16_launch,
    );
    ...
    bench_cutlass_add!(
        "cutlass_16x64_s3_add"   => cutlass_gemm_16x64_s3_bf16_launch,
        "cutlass_16x64_s4_add"   => cutlass_gemm_16x64_s4_bf16_launch,
        "cutlass_16x128_s3_add"  => cutlass_gemm_16x128_s3_bf16_launch,
        "cutlass_16x128_s4_add"  => cutlass_gemm_16x128_s4_bf16_launch,
        "cutlass_32x64_s3_add"   => cutlass_gemm_32x64_s3_bf16_launch,
        "cutlass_32x64_s4_add"   => cutlass_gemm_32x64_s4_bf16_launch,
        "cutlass_32x128_s3_add"  => cutlass_gemm_32x128_s3_bf16_launch,
        "cutlass_32x128_s4_add"  => cutlass_gemm_32x128_s4_bf16_launch,
        "cutlass_32x256_s3_add"  => cutlass_gemm_32x256_s3_bf16_launch,
        "cutlass_64x64_s3_add"   => cutlass_gemm_64x64_s3_bf16_launch,
        "cutlass_64x64_s4_add"   => cutlass_gemm_64x64_s4_bf16_launch,
        "cutlass_64x128_s3_add"  => cutlass_gemm_64x128_s3_bf16_launch,
        "cutlass_64x128_s4_add"  => cutlass_gemm_64x128_s4_bf16_launch,
        "cutlass_128x64_s3_add"  => cutlass_gemm_128x64_s3_bf16_launch,
        "cutlass_128x64_s4_add"  => cutlass_gemm_128x64_s4_bf16_launch,
        "cutlass_128x128_s3_add" => cutlass_gemm_128x128_s3_bf16_launch,
        "cutlass_128x128_s4_add" => cutlass_gemm_128x128_s4_bf16_launch,
        "cutlass_128x256_s3_add" => cutlass_gemm_128x256_s3_bf16_launch,
        "cutlass_256x64_s3_add"  => cutlass_gemm_256x64_s3_bf16_launch,
        "cutlass_256x64_s4_add"  => cutlass_gemm_256x64_s4_bf16_launch,
    );
    ...
    bench_cutlass_splitk!(
        "cutlass_64x64_s4_split2"   => cutlass_gemm_64x64_s4_sk2_bf16_launch,
        "cutlass_64x64_s4_split4"   => cutlass_gemm_64x64_s4_sk4_bf16_launch,
        "cutlass_64x64_s4_split8"   => cutlass_gemm_64x64_s4_sk8_bf16_launch,
        "cutlass_64x128_s4_split2"  => cutlass_gemm_64x128_s4_sk2_bf16_launch,
        "cutlass_64x128_s4_split4"  => cutlass_gemm_64x128_s4_sk4_bf16_launch,
        "cutlass_64x128_s4_split8"  => cutlass_gemm_64x128_s4_sk8_bf16_launch,
        "cutlass_128x64_s4_split2"  => cutlass_gemm_128x64_s4_sk2_bf16_launch,
        "cutlass_128x64_s4_split4"  => cutlass_gemm_128x64_s4_sk4_bf16_launch,
        "cutlass_128x64_s4_split8"  => cutlass_gemm_128x64_s4_sk8_bf16_launch,
        "cutlass_128x128_s4_split2" => cutlass_gemm_128x128_s4_sk2_bf16_launch,
        "cutlass_128x128_s4_split4" => cutlass_gemm_128x128_s4_sk4_bf16_launch,
        "cutlass_128x128_s4_split8" => cutlass_gemm_128x128_s4_sk8_bf16_launch,
        "cutlass_16x64_s4_split2"   => cutlass_gemm_16x64_s4_sk2_bf16_launch,
        "cutlass_16x64_s4_split4"   => cutlass_gemm_16x64_s4_sk4_bf16_launch,
        "cutlass_16x64_s4_split8"   => cutlass_gemm_16x64_s4_sk8_bf16_launch,
        "cutlass_16x128_s4_split2"  => cutlass_gemm_16x128_s4_sk2_bf16_launch,
        "cutlass_16x128_s4_split4"  => cutlass_gemm_16x128_s4_sk4_bf16_launch,
        "cutlass_16x128_s4_split8"  => cutlass_gemm_16x128_s4_sk8_bf16_launch,
    );
    ...
    bench_cutlass_bias!(
        "cutlass_gemm_bias_16x64_s3"   => cutlass_gemm_bias_16x64_s3_bf16_launch,
        "cutlass_gemm_bias_16x64_s4"   => cutlass_gemm_bias_16x64_s4_bf16_launch,
        "cutlass_gemm_bias_16x128_s3"  => cutlass_gemm_bias_16x128_s3_bf16_launch,
        "cutlass_gemm_bias_16x128_s4"  => cutlass_gemm_bias_16x128_s4_bf16_launch,
        "cutlass_gemm_bias_32x64_s3"   => cutlass_gemm_bias_32x64_s3_bf16_launch,
        "cutlass_gemm_bias_32x64_s4"   => cutlass_gemm_bias_32x64_s4_bf16_launch,
        "cutlass_gemm_bias_32x128_s3"  => cutlass_gemm_bias_32x128_s3_bf16_launch,
        "cutlass_gemm_bias_32x128_s4"  => cutlass_gemm_bias_32x128_s4_bf16_launch,
        "cutlass_gemm_bias_32x256_s3"  => cutlass_gemm_bias_32x256_s3_bf16_launch,
        "cutlass_gemm_bias_64x64_s3"   => cutlass_gemm_bias_64x64_s3_bf16_launch,
        "cutlass_gemm_bias_64x64_s4"   => cutlass_gemm_bias_64x64_s4_bf16_launch,
        "cutlass_gemm_bias_64x128_s3"  => cutlass_gemm_bias_64x128_s3_bf16_launch,
        "cutlass_gemm_bias_64x128_s4"  => cutlass_gemm_bias_64x128_s4_bf16_launch,
        "cutlass_gemm_bias_128x64_s3"  => cutlass_gemm_bias_128x64_s3_bf16_launch,
        "cutlass_gemm_bias_128x64_s4"  => cutlass_gemm_bias_128x64_s4_bf16_launch,
        "cutlass_gemm_bias_128x128_s3" => cutlass_gemm_bias_128x128_s3_bf16_launch,
        "cutlass_gemm_bias_128x128_s4" => cutlass_gemm_bias_128x128_s4_bf16_launch,
        "cutlass_gemm_bias_128x256_s3" => cutlass_gemm_bias_128x256_s3_bf16_launch,
        "cutlass_gemm_bias_256x64_s3"  => cutlass_gemm_bias_256x64_s3_bf16_launch,
        "cutlass_gemm_bias_256x64_s4"  => cutlass_gemm_bias_256x64_s4_bf16_launch,
    );
