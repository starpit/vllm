...
//! See [`crate::ir::substrate::PagePool`] for the rationale (stable-Rust
...
> MegaTapeBuilder<NUM_PAGES, NUM_CONSUMER_WARPS, PAGE_SIZE, SCRATCH_BYTES, NUM_EDGES>
{
    ...
    >(
        ...
        _out_act_slot: crate::ir::substrate::ActSlotConst<OUT_ACT_SLOT, { u32::MAX }>,
        ...
        _bar_pair: crate::ir::substrate::BarSyncPair<CONSUMER_BAR_REDUCE, CONSUMER_BAR_PUBLISH>,
        weight_path: String,
        eps: f32,
    ) -> &mut Self
    where
    ...
    >(
        ...
        _arrives: crate::ir::substrate::ArrivesCount<ARRIVES>,
        _in_page: crate::ir::substrate::PageId<IN_ID, NUM_PAGES>,
        _qkv_page: crate::ir::substrate::PageId<QKV_ID, NUM_PAGES>,
        _cos_sin_page: crate::ir::substrate::PageId<COS_SIN_ID, NUM_PAGES>,
        _q_out_page: crate::ir::substrate::PageId<Q_ID, NUM_PAGES>,
        _k_out_page: crate::ir::substrate::PageId<K_ID, NUM_PAGES>,
        _v_out_page: crate::ir::substrate::PageId<V_ID, NUM_PAGES>,
        _q_rope: crate::ir::substrate::ScratchRegion<
            Q_OFF,
            Q_BYTES,
            SCRATCH_BYTES,
            crate::ir::substrate::RopeScope,
        >,
        _k_rope: crate::ir::substrate::ScratchRegion<
            K_OFF,
            K_BYTES,
            SCRATCH_BYTES,
            crate::ir::substrate::RopeScope,
        ...
        _v_out_act_slot: crate::ir::substrate::ActSlotConst<V_OUT_ACT_SLOT, { u32::MAX }>,
        _qkv_weight_accessor_idx: crate::ir::substrate::WeightAccessorConst<
            QKV_WEIGHT_ACCESSOR_IDX,
            { u32::MAX },
        >,
        _rotary_accessor_idx: crate::ir::substrate::WeightAccessorConst<
            ROTARY_ACCESSOR_IDX,
            { u32::MAX },
        >,
    ...
    >(
        ...
        _residual_act_slot: crate::ir::substrate::ActSlotConst<RESIDUAL_ACT_SLOT, { u32::MAX }>,
        _bar_publish: crate::ir::substrate::BarSyncId<CONSUMER_BAR_PUBLISH>,
    ) -> &mut Self
    where
    ...
    >(
        ...
        _weight_accessor_idx: crate::ir::substrate::WeightAccessorConst<
            ...
            { u32::MAX },
        >,
        _bar_reduce: crate::ir::substrate::BarSyncId<CONSUMER_BAR_REDUCE>,
        _bar_publish: crate::ir::substrate::BarSyncId<CONSUMER_BAR_PUBLISH>,
        _bar_pair: crate::ir::substrate::BarSyncPair<CONSUMER_BAR_REDUCE, CONSUMER_BAR_PUBLISH>,
        weight_path: String,
        eps: f32,
    ...
    >(
        ...
        _gate: crate::ir::substrate::ScratchRegion<
            GATE_OFF, GATE_BYTES, SCRATCH_BYTES, crate::ir::substrate::MlpScope,
        >,
        ...
        _layer: crate::ir::nodes::LayerIndex<LAYER, NUM_LAYERS>,
        _hidden_dim: crate::ir::substrate::HiddenDim<HIDDEN_DIM>,
        _intermediate_dim: crate::ir::substrate::IntermediateDim<INTERMEDIATE_DIM>,
        _num_tokens: crate::ir::substrate::NumTokensConst<NUM_TOKENS>,
        _in_act_slot: crate::ir::substrate::ActSlotConst<IN_ACT_SLOT, { u32::MAX }>,
        _out_act_slot: crate::ir::substrate::ActSlotConst<OUT_ACT_SLOT, { u32::MAX }>,
        _weight_accessor_idx: crate::ir::substrate::WeightAccessorConst<
    ...
    >(
        ...
        _k: crate::ir::substrate::MatmulK<K>,
        _m: crate::ir::substrate::MatmulM<M>,
        _in_act_slot: crate::ir::substrate::ActSlotConst<IN_ACT_SLOT, { u32::MAX }>,
        _out_act_slot: crate::ir::substrate::ActSlotConst<OUT_ACT_SLOT, { u32::MAX }>,
        _weight_accessor_idx: crate::ir::substrate::WeightAccessorConst<
            WEIGHT_ACCESSOR_IDX, { u32::MAX },
    ...
    >(
        ...
        _k: crate::ir::substrate::MatmulK<K>,
        _num_tokens: crate::ir::substrate::NumTokensConst<NUM_TOKENS>,
        _k_offset: crate::ir::substrate::KOffset<K_OFFSET>,
        _k_full: crate::ir::substrate::KFull<K_FULL>,
        _in_act_slot: crate::ir::substrate::ActSlotConst<IN_ACT_SLOT, { u32::MAX }>,
        _residual_act_slot: crate::ir::substrate::ActSlotConst<RESIDUAL_ACT_SLOT, { u32::MAX }>,
        _weight_accessor_idx: crate::ir::substrate::WeightAccessorConst<
            WEIGHT_ACCESSOR_IDX, { u32::MAX },
    ...
    >(
        ...
        _arrives: crate::ir::substrate::ArrivesCount<ARRIVES>,
        _in_page: crate::ir::substrate::PageId<IN_ID, NUM_PAGES>,
        _norm_w_page: crate::ir::substrate::PageId<NORM_W_ID, NUM_PAGES>,
        _lin_w_page: crate::ir::substrate::PageId<LIN_W_ID, NUM_PAGES>,
        _out_page: crate::ir::substrate::PageId<OUT_ID, NUM_PAGES>,
        _partial: crate::ir::substrate::ScratchRegion<
            PARTIAL_OFF, PARTIAL_BYTES, SCRATCH_BYTES, crate::ir::substrate::GemmScope,
        >,
        _b_tile: crate::ir::substrate::ScratchRegion<
            B_TILE_OFF, B_TILE_BYTES, SCRATCH_BYTES, crate::ir::substrate::GemmScope,
        >,
        ...
        _in_act_slot: crate::ir::substrate::ActSlotConst<IN_ACT_SLOT, { u32::MAX }>,
        _out_act_slot: crate::ir::substrate::ActSlotConst<OUT_ACT_SLOT, { u32::MAX }>,
        _norm_weight_accessor_idx: crate::ir::substrate::WeightAccessorConst<
    ...
    >(
        ...
        _num_q_heads: crate::ir::substrate::NumQHeads<NUM_Q_HEADS>,
        _num_kv_heads: crate::ir::substrate::NumKvHeads<NUM_KV_HEADS>,
        _block_size: crate::ir::substrate::BlockSize<BLOCK_SIZE>,
        _num_tokens: crate::ir::substrate::NumTokensConst<NUM_TOKENS>,
        _max_sk: crate::ir::substrate::MaxSk<MAX_SK>,
        _q_in_act_slot: crate::ir::substrate::ActSlotConst<Q_IN_ACT_SLOT, { u32::MAX }>,
        _attn_out_act_slot: crate::ir::substrate::ActSlotConst<ATTN_OUT_ACT_SLOT, { u32::MAX }>,
        kind: AttentionKind,
        interleaved: bool,
        attn_scale: f32,
        attn_softcap: f32,
    ...
    pub fn finish(self, num_layers: u32) -> MegaTape {
        let budget = crate::ir::tape::TapeBudget {
            num_pages: NUM_PAGES,
...
// u32 values as const-generic args isn't legal Rust. The proc-macro
// builds the typed `MegaTape` by EMITTING literal
// `MegaTapeBuilder::push_*::<...>(weight_path)` calls at expansion
// time; user-build monomorphization fires the `const {}` blocks.
// `ferrite-megakernel::codegen` does take an `Instruction`-shaped
// dispatch fn but only to translate it to the literal-const-arg
// emit form — there is no runtime-dispatch entry point.
...
mod tests {
    ...
    fn rejects_cross_op_alias_runtime() {
        ...
        let mut pool = crate::ir::substrate::PagePool::new(6);
        let _ = pool.take(1);
    ...
    fn barriers_do_not_advance_arrives() {
        ...
        let mut b = BuilderD::new();
        b.push_barrier_signal::<0>(crate::ir::substrate::EdgeId::<0, 4>::new());
        b.push_barrier_wait::<0, 4>(
            crate::ir::substrate::EdgeId::<0, 4>::new(),
            crate::ir::substrate::ExpectedCount::<4>::new(),
        );
        b.push_rms_norm(
            ArrivesCount::<0>::new(),
            PageId::<0, 8>::new(),
