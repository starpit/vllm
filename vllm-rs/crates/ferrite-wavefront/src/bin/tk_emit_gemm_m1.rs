...
//! Single-op (GemmM1) reproducer for the Phase 6 tile-golden harness.

use std::path::PathBuf;

use ferrite_wavefront::fixtures::{gemm_m1_only_input, orchestrator_kernel_args};
use ferrite_wavefront::tk_codegen::{emit_kernel_with_opts, EmitOpts};
use ferrite_wavefront::tk_orchestrate::lower_to_tk;

const KERNEL_NAME: &str = "tk_decode_gemm_m1";
