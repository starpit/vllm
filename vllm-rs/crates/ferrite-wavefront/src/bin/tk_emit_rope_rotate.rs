...
//! Single-op (RopeRotate) reproducer for the Phase 6 tile-golden harness.

use std::path::PathBuf;

use ferrite_wavefront::fixtures::{orchestrator_kernel_args, rope_rotate_only_input};
use ferrite_wavefront::tk_codegen::{emit_kernel_with_opts, EmitOpts};
use ferrite_wavefront::tk_orchestrate::lower_to_tk;

const KERNEL_NAME: &str = "tk_decode_rope_rotate";
