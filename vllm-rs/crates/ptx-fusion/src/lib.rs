...
pub use ptx_fusion_macros::{
    ...
    persistent_fuse_real_kernels, persistent_gemm, prologue_identity, prologue_identity_flat,
    prologue_scale2_flat, regfuse_kernels, replace_cutlass_a_loads, replace_perimeter_macro,
    rewrite_kernel, sequence_gemms, sequence_mlp_block, sequence_segment_b,
};
