    ...
    cudaStream_t stream)
{
    ...
    mul_mat_vec_q4_0_q8_1_cuda1<<<grid, block, 0, stream>>>(vx, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}
    ...
    cudaStream_t stream)
{
    dim3 grid(nrows_x, 1, 1);
    dim3 block(WARP_SIZE, 4, 1);
    mul_mat_vec_q4_1_q8_1_cuda1<<<grid, block, 0, stream>>>(vx, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}
    ...
    cudaStream_t stream)
{
    dim3 grid(nrows_x, 1, 1);
    dim3 block(WARP_SIZE, 4, 1);
    mul_mat_vec_q5_0_q8_1_cuda1<<<grid, block, 0, stream>>>(vx, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}
    ...
    cudaStream_t stream)
{
    dim3 grid(nrows_x, 1, 1);
    dim3 block(WARP_SIZE, 4, 1);
    mul_mat_vec_q5_1_q8_1_cuda1<<<grid, block, 0, stream>>>(vx, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}
    ...
    cudaStream_t stream)
{
    dim3 grid(nrows_x, 1, 1);
    dim3 block(WARP_SIZE, 4, 1);
    mul_mat_vec_q8_0_q8_1_cuda1<<<grid, block, 0, stream>>>(vx, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}
    ...
    cudaStream_t stream)
{
    dim3 grid(nrows_x, 1, 1);
    dim3 block(WARP_SIZE, 4, 1);
    mul_mat_vec_q2_K_q8_1_cuda1<<<grid, block, 0, stream>>>(vx, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}
    ...
    cudaStream_t stream)
{
    dim3 grid(nrows_x, 1, 1);
    dim3 block(WARP_SIZE, 4, 1);
    mul_mat_vec_q3_K_q8_1_cuda1<<<grid, block, 0, stream>>>(vx, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}
    ...
    cudaStream_t stream)
{
    dim3 grid(nrows_x, 1, 1);
    dim3 block(WARP_SIZE, 4, 1);
    mul_mat_vec_q4_K_q8_1_cuda1<<<grid, block, 0, stream>>>(vx, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}
    ...
    cudaStream_t stream)
{
    dim3 grid(nrows_x, 1, 1);
    dim3 block(WARP_SIZE, 4, 1);
    mul_mat_vec_q5_K_q8_1_cuda1<<<grid, block, 0, stream>>>(vx, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}
    ...
    cudaStream_t stream)
{
    dim3 grid(nrows_x, 1, 1);
    dim3 block(WARP_SIZE, 4, 1);
    mul_mat_vec_q6_K_q8_1_cuda1<<<grid, block, 0, stream>>>(vx, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}
    ...
    cudaStream_t stream)
{
    dim3 grid(nrows_x, 1, 1);
    dim3 block(WARP_SIZE, 4, 1);
    mul_mat_vec_iq1_m_q8_1_cuda1<<<grid, block, 0, stream>>>(vx, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}
    ...
    cudaStream_t stream)
{
    dim3 grid(nrows_x, 1, 1);
    dim3 block(WARP_SIZE, 4, 1);
    mul_mat_vec_iq1_s_q8_1_cuda1<<<grid, block, 0, stream>>>(vx, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}
    ...
    cudaStream_t stream)
{
    dim3 grid(nrows_x, 1, 1);
    dim3 block(WARP_SIZE, 4, 1);
    mul_mat_vec_iq2_xxs_q8_1_cuda1<<<grid, block, 0, stream>>>(vx, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}
    ...
    cudaStream_t stream)
{
    dim3 grid(nrows_x, 1, 1);
    dim3 block(WARP_SIZE, 4, 1);
    mul_mat_vec_iq2_s_q8_1_cuda1<<<grid, block, 0, stream>>>(vx, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}
    ...
    cudaStream_t stream)
{
    dim3 grid(nrows_x, 1, 1);
    dim3 block(WARP_SIZE, 4, 1);
    mul_mat_vec_iq3_s_q8_1_cuda1<<<grid, block, 0, stream>>>(vx, vy, dst, ncols_x, nrows_x, nrows_y, nrows_dst);
}
