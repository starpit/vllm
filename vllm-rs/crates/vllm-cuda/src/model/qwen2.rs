...
//!
//! This file is currently a thin wrapper around `LlamaForCausalLM`
//! used for Qwen2's quant/TP/PP paths. Dense bf16 Qwen2 through
//! ferrite-forward is blocked on the bias-fused-QKV Impl (HANDOFF
//! Step C, gap #5); until then dense Qwen2 also routes here.
