...
impl TestModels {
    ...
    // Kimi K2 — 4-layer synthetic tiny model. Same MLA shape as DEEPSEEK_V3_TINY_CUDA
    // but flat sigmoid+noaux_tc routing (n_group=1, topk_group=1), first_k_dense_replace=1,
    // routed_scaling_factor=2.827 — exercises K2's parametric knobs over the V3 carrier.
    // Generated by scripts/make_tiny_kimi_k2.py. Must pre-exist on the test host.
    pub const KIMI_K2_TINY_CUDA: &str = "/tmp/kimi-k2-tiny";
