...
// Stripped version of vLLM core/scalar_type.hpp without torch dependencies.
// Only TORCH_CHECK is replaced — the class itself is unchanged.
...
// Replace TORCH_CHECK with a no-op for constexpr compatibility.
// All constexpr uses pass valid parameters for our predefined types.
#ifndef TORCH_CHECK
