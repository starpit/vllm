...
| Quantized MoE (FP8/INT8/INT4 experts) | ✅ | ⚠️ | FP8 MoE: dequant-to-BF16 at load time (correctness path); INT4 MoE: Marlin MoE W4A16 kernel (AWQ/GPTQ) for Qwen3MoE/Qwen2MoE/Mixtral; dynamic moe_block_size selection; compressed-tensors + quantize_config.json detection. TODO: native FP8 fused MoE GEMM; block-quantized FP8 MoE (DeepSeek-V3); INT8 quantized MoE experts; fused MoE scale merging at runtime |
